// Preset values version of customizer.scad for creating small cherry profile-ish spacebars

/* [Basic-Settings] */

// what preset profile do you wish to use? disable if you are going to set paramters below
key_profile = "disable"; // [dcs, oem, dsa, sa, g20, disable]
...
$key_length = 2; // Range not working in thingiverse customizer atm [1:0.25:16]
...
$dish_type = "sideways cylindrical"; // [cylindrical, spherical, sideways cylindrical, old spherical, disable]
